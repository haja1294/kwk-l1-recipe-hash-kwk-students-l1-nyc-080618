...
perfect_10_recipe = {
  :almond_flour => "2 cups" , :gluten_freewhole_oats => "1 cup" , :kosher_salt => "1/2 tea spoon" , :baking_powder => "1/2 tea spoon" , :baking_soda => "1/4 tea spoon" , :Xanthan_Gum => "1/2 tea spoon" , :silvered_almonds_lightly_toasted => "1/4 cup" , :mini_dark_choclate_chips => "3/4 cup", :olive_oil => "1/2 cup", :agave => "1/4 cup"
 
}
#2. Write a method that simply returns (not puts) your perfect_10 hash

def recipe_ingredients(perfect_10_recipe)
  puts recipe_ingredients.length
end
recipe_ingredients.length
